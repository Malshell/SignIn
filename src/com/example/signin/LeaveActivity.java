...
public class LeaveActivity extends Activity implements OnClickListener {
	...
	public static LeaveActivity instance = null;
		...
		public void handleMessage(Message msg) {
			...
			case AppService.GET_ALL_USER: {
				...
				for (int i = 0; i < allusers.size(); i++) {
					...
					name[i] = user.getName();
					sex[i] = user.getSex();
					registerStatus[i] = user.getRegisterStatus();
					userAvatarUrl[i] = user.getUserAvatarUrl();
	...
	public void onClick(View v) {
		...
		case R.id.user1:
			...
			intent.setClass(LeaveActivity.this, UserLeaveActivity.class);
